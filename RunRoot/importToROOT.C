{
  ...
  gROOT->LoadMacro("$CLAS12TOOL/Hipo4/utils.cpp+");
  gROOT->LoadMacro("$CLAS12TOOL/Hipo4/dictionary.cpp+");
  // gROOT->LoadMacro("$CLAS12TOOL/Hipo4/node.cpp+");
  gROOT->LoadMacro("$CLAS12TOOL/Hipo4/event.cpp+");
  gROOT->LoadMacro("$CLAS12TOOL/Hipo4/record.cpp+");
  gROOT->LoadMacro("$CLAS12TOOL/Hipo4/bank.cpp+");
  gROOT->LoadMacro("$CLAS12TOOL/Hipo4/reader.cpp+");
