...
using p4_uptr = std::unique_ptr<P4_t>;
...
void Ex1_CLAS12Reader(){
  ...
  //ignore this just getting file name!
   ...
   auto el=p4_uptr(new P4_t(0,0,0,db->GetParticle(11)->Mass()));
   auto pr=p4_uptr(new P4_t(0,0,0,db->GetParticle(2212)->Mass()));
   auto g1=p4_uptr(new P4_t(0,0,0,0));
   auto g2=p4_uptr(new P4_t(0,0,0,0));
   auto pip=p4_uptr(new P4_t(0,0,0,db->GetParticle(211)->Mass()));
   auto pim=p4_uptr(new P4_t(0,0,0,db->GetParticle(-211)->Mass()));
