{
  ...
  hists.Hist1D("PBANK.Rows",100,0,100,"")->Draw("");

  hists.Hist1D("P.Theta*TMath::RadToDeg()",180,0,180);
  hists.Hist1D("P.Phi*TMath::RadToDeg()",180,-180,180);
  hists.Hist1D("P.P",100,0.1,12);
  hists.Hist1D("P.Time-EVNT.StartTime",1000,-200,200,"P.Time")->Draw("(2x2)"); //Note zero suppression

  hists.Hist1D("atan2(sqrt(PBANK.Px*PBANK.Px+PBANK.Py*PBANK.Py),PBANK.Pz)*57.295780",180,0,180,"P.Time");
  hists.Hist1D("atan2(PBANK.Py,PBANK.Px)*TMath::RadToDeg()",180,-180,180,"P.Time");
  hists.Hist1D("sqrt(PBANK.Px*PBANK.Px+PBANK.Py*PBANK.Py+PBANK.Pz*PBANK.Pz)",100,0.1,12);
  hists.Hist1D("FTOF1B.Time-EVNT.StartTime",1000,-200,200,"P.Time")->Draw("(2x2)");

  hists.Hist1D("P.Theta*TMath::RadToDeg()",180,0,180,"P.Pid==11");
  hists.Hist1D("P.Phi*TMath::RadToDeg()",180,-180,180,"P.Pid==11");
  hists.Hist1D("P.P",100,0.1,12,"P.Pid==11");
  hists.Hist1D("P.Time-EVNT.StartTime",1000,-200,200,"P.Time&&P.Pid==11")->Draw("(2x2)");

  hists.Hist1D("P.Theta*TMath::RadToDeg()",180,0,180,"P.Pid==2212");
  hists.Hist1D("P.Phi*TMath::RadToDeg()",180,-180,180,"P.Pid==2212");
  hists.Hist1D("P.P",100,0.1,12,"P.Pid==2212");
  hists.Hist1D("P.Time-EVNT.StartTime",1000,-200,200,"P.Time&&P.Pid==2212")->Draw("(2x2)");
